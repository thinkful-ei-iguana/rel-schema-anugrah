...
-- create the project table, it depends on no other table
...
-- make the foreign keys immediately as the two dependencies exist
...
-- create the employee_project table with references to both employee and project the primary key is made up of two columns
